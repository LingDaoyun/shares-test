    ...
    <section className="border border-emerald-200 bg-emerald-50/50 px-3 py-3">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-emerald-900">隔夜交易纪律</h3>
      ...
      <div className="mt-3 grid gap-2 md:grid-cols-3">
        {plan.openScenarios.map((scenario) => (
          <div key={scenario.code} className="border-l-2 border-emerald-300 bg-white/70 px-3 py-2">
...
function PlanMetric({ label, value }: { label: string; value: string }) {
  return (
    <div className="border border-emerald-100 bg-white/70 px-2 py-2">
