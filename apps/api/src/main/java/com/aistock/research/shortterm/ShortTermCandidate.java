...
public record ShortTermCandidate(
        ...
        ShortTermSignalProfile signalProfile
) {
    public ShortTermCandidate {
        ...
        industryLeadership = industryLeadership == null
                ...
                : industryLeadership;
        volatilityQuality = volatilityQuality == null
                ? ShortTermVolatilityQuality.unavailable("历史报告未包含波动质量快照")
                : volatilityQuality;
        signalProfile = signalProfile == null
                ? ShortTermSignalProfile.unavailable("历史报告未包含信号族快照")
                : signalProfile;
    }
    ...
    public ShortTermCandidate(
        ...
        this(
                ...
                tradePlan, chip, relativeStrength, industryLeadership,
                ShortTermVolatilityQuality.unavailable("历史报告未包含波动质量快照"),
                ShortTermSignalProfile.unavailable("历史报告未包含信号族快照")
        );
    }
